...
public class FishTrail : MonoBehaviour {
    ...
    void RecordPosition() {
        ...
        pastPositions.Add( transform.position );            // add our current position to our list of past positions // Capital T is the idea of a transfrom and lower casae is a single instance
